                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="post_title" class="form-control" name="title" value="{{ $post->title }}">
                                </div>
                            </div>
                            ...
                            <input type="checkbox" id="post_status" class="filled-in" name="status" {{ $post->status == true ? 'checked' : '' }}>
